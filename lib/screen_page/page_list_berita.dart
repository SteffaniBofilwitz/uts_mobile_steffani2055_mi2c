...
import 'package:uts_steffani2055/screen_page/page_detail_berita.dart';
import 'package:uts_steffani2055/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.100.44/uts_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.100.44/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
                                ListTile(
                                  ...
                                  subtitle: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4), // Memberi sedikit spasi antara konten dan info tambahan
                                      Row(
                                        children: [
                                          Text(
                                            'Author: ${data.author}', // Ganti 'data.author' dengan sumber author Anda
                                            style: TextStyle(
                                              fontSize: 10,
                                              color: Colors.grey,
                                            ),
                                          ),
                                          SizedBox(width: 8), // Memberi sedikit spasi antara author dan tanggal
                                          Text(
                                            'Tanggal: ${data.created}', // Ganti 'data.tanggal' dengan sumber tanggal Anda
                                            style: TextStyle(
                                              fontSize: 10,
                                              color: Colors.grey,
                                            ),
